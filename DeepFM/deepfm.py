...
if __name__ == '__main__':
    ...
    Xi = np.hstack((i_genre, i_other))
    Xv = np.hstack((x_genre, x_other))
    Xi_train, Xv_train, y_train = (Xi[idx0], Xv[idx0], y[idx0])
    Xi_valid, Xv_valid, y_valid = (Xi[idx1], Xv[idx1], y[idx1])
    ...
    dfm_params["feature_size"] = 3530
    dfm_params["field_size"] = 12
